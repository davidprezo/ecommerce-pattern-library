 ...
 * @version 1519913505767
 */
const patternManifest_1519913505767 = {
  "commonInfo": {
    "theme": [],
    "readme": {
      "attributes": {
        "checkbox": "This checkbox lets users select and confirm.\n",
        "input-fields": "This is a standard text field.\n",
        "dropdown": "This lets users choose an item from a dropdown menu.\n",
        "radio-button": "This button is used when the user can only choose one out of multiple options.\n",
...
patternBotIncludes(patternManifest_1519913505767);
}());